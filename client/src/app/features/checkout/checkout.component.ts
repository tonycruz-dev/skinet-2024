...
@Component({
  ...
  standalone: true,
  imports: [OrderSummaryComponent, MatStepperModule, MatCheckboxModule, CheckoutDeliveryComponent, CheckoutReviewComponent, MatProgressSpinnerModule, CommonModule],
